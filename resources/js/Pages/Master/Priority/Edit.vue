...
const form = useForm({
    ...
    color: props.priority.color || '#000000',
});

const submit = () => {
    form.put(route('master.priorities.update', props.priority.id));
};
</script>

<template>
    <Head title="Edit Prioritas" />

    <AppLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Prioritas</h2>
        </template>
